  ...
  _handleMessage(event) {
    return __awaiter2(this, void 0, void 0, function* () {
      ...
      if (data.type === "REMIX_NAVIGATION") {
        ...
        let [dataCache, documentCache2, existingDocument] = yield Promise.all([
          caches.open(DATA),
          caches.open(PAGES),
          caches.match(documentUrl)
        ]);
        if (!existingDocument || !isMount) {
          cachePromises.set(documentUrl, documentCache2.add(documentUrl).catch((error) => {
...
var assetsCache = new CacheFirst({
...
var loaderCache = new NetworkFirst({
